#!/bin/bash
#SBATCH --job-name=convirt_resnet_optimized
#SBATCH --output=logs/sbatch/convirt_resnet_optimized-%A.out
#SBATCH --error=logs/sbatch/convirt_resnet_optimized-%A.err
...
srun python src/pretrain.py +experiment=convirt_resnet_optimized