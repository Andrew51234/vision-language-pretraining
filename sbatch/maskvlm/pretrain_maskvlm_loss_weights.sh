#!/bin/bash
#SBATCH --job-name=maskvlm_loss_weights
#SBATCH --output=logs/sbatch/maskvlm_loss_weights-%A.out
#SBATCH --error=logs/sbatch/maskvlm_loss_weights-%A.err
...
srun python src/pretrain.py +experiment=maskvlm_loss_weights