#!/bin/bash
#SBATCH --job-name=maskvlm_n_sentences
#SBATCH --output=logs/sbatch/maskvlm_n_sentences-%A.out
#SBATCH --error=logs/sbatch/maskvlm_n_sentences-%A.err
...
srun python src/pretrain.py +experiment=maskvlm_n_sentences