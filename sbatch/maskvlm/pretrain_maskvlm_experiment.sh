#!/bin/bash
#SBATCH --job-name=maskvlm_experiment
#SBATCH --output=logs/sbatch/maskvlm_experiment-%A.out
#SBATCH --error=logs/sbatch/maskvlm_experiment-%A.err
...
srun python src/pretrain.py +experiment=maskvlm