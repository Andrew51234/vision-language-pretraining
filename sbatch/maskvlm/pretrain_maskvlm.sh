#!/bin/bash
#SBATCH --job-name=maskvlm
#SBATCH --output=logs/sbatch/maskvlm-%A.out
#SBATCH --error=logs/sbatch/maskvlm-%A.err
...
srun python src/pretrain.py +experiment=maskvlm_default