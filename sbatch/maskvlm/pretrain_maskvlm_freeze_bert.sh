#!/bin/bash
#SBATCH --job-name=maskvlm_freeze_bert
#SBATCH --output=logs/sbatch/maskvlm_freeze_bert-%A.out
#SBATCH --error=logs/sbatch/maskvlm_freeze_bert-%A.err
...
srun python src/pretrain.py +experiment=maskvlm_freeze_bert