#!/bin/bash
#SBATCH --job-name=ConVIRT-vit
#SBATCH --output=logs/sbatch/ConVIRT-vit-%A.out
#SBATCH --error=logs/sbatch/ConVIRT-vit-%A.err
...
# always run this script from a cleavitn terminal
conda deactivate
...
srun python src/pretrain.py +experiment=convirt_vit