#!/bin/bash
#SBATCH --job-name=NLMCXR-convirt-resnet-3-sentences
#SBATCH --array=0-2  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-convirt-resnet-3-sentences-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-convirt-resnet-3-sentences-%A_%a.err
...
experiments=(
  "finetune/retrieval/convirt/resnet_3_sentences/finetune_nlmcxr_subset_01_convirt_resnet_3_sentences"
  "finetune/retrieval/convirt/resnet_3_sentences/finetune_nlmcxr_subset_10_convirt_resnet_3_sentences"
  "finetune/retrieval/convirt/resnet_3_sentences/finetune_nlmcxr_convirt_resnet_3_sentences"
)
...
srun python src/finetune_nlmcxr.py +experiment=$experiment