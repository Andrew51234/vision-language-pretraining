#!/bin/bash
#SBATCH --job-name=NLMCXR-convirt-vit-128
#SBATCH --array=0-1  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-convirt-vit-128-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-convirt-vit-128-%A_%a.err
...
experiments=(
  "finetune/retrieval/convirt/vit_128/finetune_nlmcxr_subset_01_convirt_vit_128"
  "finetune/retrieval/convirt/vit_128/finetune_nlmcxr_subset_10_convirt_vit_128"
)
