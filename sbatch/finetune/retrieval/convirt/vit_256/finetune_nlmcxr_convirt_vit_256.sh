#!/bin/bash
#SBATCH --job-name=NLMCXR-convirt-vit-256
#SBATCH --array=0-1  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-convirt-vit-256-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-convirt-vit-256-%A_%a.err
...
experiments=(
  "finetune/retrieval/convirt/vit_256/finetune_nlmcxr_subset_01_convirt_vit_256"
  "finetune/retrieval/convirt/vit_256/finetune_nlmcxr_subset_10_convirt_vit_256"
)
