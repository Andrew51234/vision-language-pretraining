#!/bin/bash
#SBATCH --job-name=NLMCXR-convirt-resnet-256
#SBATCH --array=0-1  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-convirt-resnet-256-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-convirt-resnet-256-%A_%a.err
...
experiments=(
  "finetune/retrieval/convirt/resnet_256/finetune_nlmcxr_subset_01_convirt_resnet_256"
  "finetune/retrieval/convirt/resnet_256/finetune_nlmcxr_subset_10_convirt_resnet_256"
)
