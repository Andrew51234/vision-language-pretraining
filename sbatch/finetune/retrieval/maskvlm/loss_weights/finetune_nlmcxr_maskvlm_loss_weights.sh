#!/bin/bash
#SBATCH --job-name=NLMCXR-maskvlm-loss-weights
#SBATCH --array=0-1  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-maskvlm-loss-weights-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-maskvlm-loss-weights-%A_%a.err
...
experiments=(
  "finetune/retrieval/maskvlm/loss_weights/finetune_nlmcxr_subset_01_maskvlm_loss_weights"
  "finetune/retrieval/maskvlm/loss_weights/finetune_nlmcxr_subset_10_maskvlm_loss_weights"
)
