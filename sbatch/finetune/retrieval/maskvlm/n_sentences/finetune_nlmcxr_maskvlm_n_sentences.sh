#!/bin/bash
#SBATCH --job-name=NLMCXR-maskvlm-n-sentences
#SBATCH --array=0-1  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-maskvlm-n-sentences-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-maskvlm-n-sentences-%A_%a.err
...
experiments=(
  "finetune/retrieval/maskvlm/n_sentences/finetune_nlmcxr_subset_01_maskvlm_n_sentences"
  "finetune/retrieval/maskvlm/n_sentences/finetune_nlmcxr_subset_10_maskvlm_n_sentences"
)
