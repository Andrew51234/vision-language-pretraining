#!/bin/bash
#SBATCH --job-name=NLMCXR-maskvlm-freeze-bert
#SBATCH --array=0-1  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-maskvlm-freeze-bert-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-maskvlm-freeze-bert-%A_%a.err
...
experiments=(
  "finetune/retrieval/maskvlm/freeze_bert/finetune_nlmcxr_subset_01_maskvlm_freeze_bert"
  "finetune/retrieval/maskvlm/freeze_bert/finetune_nlmcxr_subset_10_maskvlm_freeze_bert"
)
