#!/bin/bash
#SBATCH --job-name=NLMCXR-maskvlm-default
#SBATCH --array=0-1  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-maskvlm-default-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-maskvlm-default-%A_%a.err
...
experiments=(
  "finetune/retrieval/maskvlm/default/finetune_nlmcxr_subset_01_maskvlm_default"
  "finetune/retrieval/maskvlm/default/finetune_nlmcxr_subset_10_maskvlm_default"
)
