#!/bin/bash
#SBATCH --job-name=NLMCXR-random
#SBATCH --array=0-2  # indices 0, 1, and 2
#SBATCH --output=logs/sbatch/NLMCXR-random-%A_%a.out
#SBATCH --error=logs/sbatch/NLMCXR-random-%A_%a.err
...
experiments=(
  "finetune/retrieval/random/finetune_nlmcxr_subset_01_random"
  "finetune/retrieval/random/finetune_nlmcxr_subset_10_random"
  "finetune/retrieval/random/finetune_nlmcxr_random"
)
...
srun python src/finetune_nlmcxr.py --config-name=finetune_nlmcxr_random +experiment=$experiment 