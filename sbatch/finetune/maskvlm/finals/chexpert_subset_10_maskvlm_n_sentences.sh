#!/bin/bash
#SBATCH --job-name=chexpert_subset_10_maskvlm_n_sentences
#SBATCH --output=logs/sbatch/chexpert_subset_10_maskvlm_n_sentences-%A.out
#SBATCH --error=logs/sbatch/chexpert_subset_10_maskvlm_n_sentences-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/maskvlm/finals/chexpert_subset_10_maskvlm_n_sentences