#!/bin/bash
#SBATCH --job-name=chexpert_subset_01_maskvlm_loss_weights
#SBATCH --output=logs/sbatch/chexpert_subset_01_maskvlm_loss_weights-%A.out
#SBATCH --error=logs/sbatch/chexpert_subset_01_maskvlm_loss_weights-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/maskvlm/finals/chexpert_subset_01_maskvlm_loss_weights