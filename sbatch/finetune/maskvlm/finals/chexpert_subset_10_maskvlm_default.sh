#!/bin/bash
#SBATCH --job-name=chexpert_subset_10_maskvlm_default   
#SBATCH --output=logs/sbatch/chexpert_subset_10_maskvlm_default-%A.out
#SBATCH --error=logs/sbatch/chexpert_subset_10_maskvlm_default-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/maskvlm/finals/chexpert_subset_10_maskvlm_default