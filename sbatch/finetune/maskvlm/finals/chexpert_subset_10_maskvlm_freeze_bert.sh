#!/bin/bash
#SBATCH --job-name=chexpert_subset_10_maskvlm_freeze_bert
#SBATCH --output=logs/sbatch/chexpert_subset_10_maskvlm_freeze_bert-%A.out
#SBATCH --error=logs/sbatch/chexpert_subset_10_maskvlm_freeze_bert-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/maskvlm/finals/chexpert_subset_10_maskvlm_freeze_bert