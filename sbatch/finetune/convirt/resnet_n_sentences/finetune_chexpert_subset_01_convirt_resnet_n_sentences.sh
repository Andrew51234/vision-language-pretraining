#!/bin/bash
#SBATCH --job-name=finetune_chexpert_subset_01_convirt_resnet_n_sentences
#SBATCH --output=logs/sbatch/finetune_chexpert_subset_01_convirt_resnet_n_sentences-%A.out
#SBATCH --error=logs/sbatch/finetune_chexpert_subset_01_convirt_resnet_n_sentences-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/convirt/resnet_n_sentences/finetune_chexpert_subset_01_convirt_resnet_n_sentences