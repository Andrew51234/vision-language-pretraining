#!/bin/bash
#SBATCH --job-name=CheXpert-subset-10-maskvlm-03
#SBATCH --output=logs/sbatch/CheXpert-subset-10-maskvlm-03-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-10-maskvlm-03-%A.err
...
srun python src/finetune_chexpert.py --config-name=finetune_chexpert_maskvlm +experiment=finetune/classification/maskvlm/03/finetune_chexpert_subset_10_maskvlm_03