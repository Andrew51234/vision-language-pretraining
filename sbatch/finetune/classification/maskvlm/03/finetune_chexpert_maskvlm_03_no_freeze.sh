#!/bin/bash
#SBATCH --job-name=CheXpert-maskvlm-03-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-maskvlm-03-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-maskvlm-03-no-freeze-%A.err
...
srun python src/finetune_chexpert.py --config-name=finetune_chexpert_maskvlm +experiment=finetune/classification/maskvlm/03/finetune_chexpert_maskvlm_03_no_freeze