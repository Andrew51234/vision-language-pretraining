#!/bin/bash
#SBATCH --job-name=CheXpert-maskvlm-06-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-maskvlm-06-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-maskvlm-06-no-freeze-%A.err
...
srun python src/finetune_chexpert.py --config-name=finetune_chexpert_maskvlm +experiment=finetune/classification/maskvlm/06/finetune_chexpert_maskvlm_06_no_freeze