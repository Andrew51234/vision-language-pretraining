#!/bin/bash
#SBATCH --job-name=CheXpert-subset-10-vit-128-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-subset-10-vit-128-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-10-vit-128-no-freeze-%A.err
...
srun python src/finetune_chexpert.py --config-name=finetune_chexpert_vit +experiment=finetune/classification/convirt/vit_128/finetune_chexpert_subset_10_vit_128_no_freeze