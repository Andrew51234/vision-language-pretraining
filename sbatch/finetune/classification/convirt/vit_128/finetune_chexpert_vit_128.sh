#!/bin/bash
#SBATCH --job-name=CheXpert-vit-128
#SBATCH --output=logs/sbatch/CheXpert-vit-128-%A.out
#SBATCH --error=logs/sbatch/CheXpert-vit-128-%A.err
...
srun python src/finetune_chexpert.py --config-name=finetune_chexpert_vit +experiment=finetune/classification/convirt/vit_128/finetune_chexpert_vit_128