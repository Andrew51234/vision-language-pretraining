#!/bin/bash
#SBATCH --job-name=CheXpert-subset-01-convirt-resnet-256
#SBATCH --output=logs/sbatch/CheXpert-subset-01-convirt-resnet-256-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-01-convirt-resnet-256-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/resnet_256/finetune_chexpert_subset_01_convirt_resnet_256