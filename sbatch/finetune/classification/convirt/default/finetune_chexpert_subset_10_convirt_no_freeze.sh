#!/bin/bash
#SBATCH --job-name=CheXpert-subset-10-convirt-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-subset-10-convirt-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-10-convirt-no-freeze-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/default/finetune_chexpert_subset_10_convirt_no_freeze