#!/bin/bash
#SBATCH --job-name=CheXpert-convirt-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-convirt-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-convirt-no-freeze-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/default/finetune_chexpert_convirt_no_freeze