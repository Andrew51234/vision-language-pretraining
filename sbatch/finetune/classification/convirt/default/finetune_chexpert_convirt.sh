#!/bin/bash
#SBATCH --job-name=CheXpert-convirt
#SBATCH --output=logs/sbatch/CheXpert-convirt-%A.out
#SBATCH --error=logs/sbatch/CheXpert-convirt-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/default/finetune_chexpert_convirt