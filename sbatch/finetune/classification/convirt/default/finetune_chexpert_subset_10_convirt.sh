#!/bin/bash
#SBATCH --job-name=CheXpert-subset-10-convirt
#SBATCH --output=logs/sbatch/CheXpert-subset-10-convirt-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-10-convirt-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/default/finetune_chexpert_subset_10_convirt