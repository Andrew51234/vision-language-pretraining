#!/bin/bash
#SBATCH --job-name=CheXpert-subset-01-convirt-resnet-32
#SBATCH --output=logs/sbatch/CheXpert-subset-01-convirt-resnet-32-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-01-convirt-resnet-32-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/resnet_32/finetune_chexpert_subset_01_convirt_resnet_32