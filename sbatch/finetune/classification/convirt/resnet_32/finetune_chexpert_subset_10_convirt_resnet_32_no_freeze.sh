#!/bin/bash
#SBATCH --job-name=CheXpert-subset-10-convirt-resnet-32-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-subset-10-convirt-resnet-32-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-10-convirt-resnet-32-no-freeze-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/resnet_32/finetune_chexpert_subset_10_convirt_resnet_32_no_freeze