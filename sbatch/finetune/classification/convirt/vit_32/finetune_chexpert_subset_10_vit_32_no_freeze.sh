#!/bin/bash
#SBATCH --job-name=CheXpert-subset-10-vit-32-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-subset-10-vit-32-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-10-vit-32-no-freeze-%A.err
...
srun python src/finetune_chexpert.py --config-name=finetune_chexpert_vit +experiment=finetune/classification/convirt/vit_32/finetune_chexpert_subset_10_vit_32_no_freeze