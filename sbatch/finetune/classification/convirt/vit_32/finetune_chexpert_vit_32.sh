#!/bin/bash
#SBATCH --job-name=CheXpert-vit-32
#SBATCH --output=logs/sbatch/CheXpert-vit-32-%A.out
#SBATCH --error=logs/sbatch/CheXpert-vit-32-%A.err
...
srun python src/finetune_chexpert.py --config-name=finetune_chexpert_vit +experiment=finetune/classification/convirt/vit_32/finetune_chexpert_vit_32