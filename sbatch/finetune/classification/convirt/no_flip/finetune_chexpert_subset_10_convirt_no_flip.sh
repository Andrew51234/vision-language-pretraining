#!/bin/bash
#SBATCH --job-name=CheXpert-subset-10-convirt-no-flip
#SBATCH --output=logs/sbatch/CheXpert-subset-10-convirt-no-flip-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-10-convirt-no-flip-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/no_flip/finetune_chexpert_subset_10_convirt_no_flip