#!/bin/bash
#SBATCH --job-name=CheXpert-subset-01-convirt-resnet-128
#SBATCH --output=logs/sbatch/CheXpert-subset-01-convirt-resnet-128-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-01-convirt-resnet-128-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/resnet_128/finetune_chexpert_subset_01_convirt_resnet_128