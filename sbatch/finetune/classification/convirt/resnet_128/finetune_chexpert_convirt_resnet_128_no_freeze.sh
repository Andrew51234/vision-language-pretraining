#!/bin/bash
#SBATCH --job-name=CheXpert-convirt-resnet-128-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-convirt-resnet-128-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-convirt-resnet-128-no-freeze-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/resnet_128/finetune_chexpert_convirt_resnet_128_no_freeze