#!/bin/bash
#SBATCH --job-name=CheXpert-subset-01-convirt-resnet-128-no-freeze
#SBATCH --output=logs/sbatch/CheXpert-subset-01-convirt-resnet-128-no-freeze-%A.out
#SBATCH --error=logs/sbatch/CheXpert-subset-01-convirt-resnet-128-no-freeze-%A.err
...
srun python src/finetune_chexpert.py +experiment=finetune/classification/convirt/resnet_128/finetune_chexpert_subset_01_convirt_resnet_128_no_freeze